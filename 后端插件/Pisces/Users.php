...
$users = $db->fetchAll($db->select()->from('table.pisces')
    ->order('table.pisces.createtime', Typecho_Db::SORT_DESC));

$pageCount = ceil( count($users)/$pageSize );

$userpage = $db->fetchAll($db->select()->from('table.pisces')
        ...
        <div class="row typecho-page-main" role="main">
            <div class="col-mb-12 typecho-list">
                <div class="typecho-list-operate clearfix">
                    <form method="POST" action="<?php $options->adminUrl('extending.php?panel=Pisces%2FUsers.php'); ?>">
